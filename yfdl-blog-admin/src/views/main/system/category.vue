  ...
  <div class="category">
    ...
    <el-form :model="queryParams">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="分类名">
            <el-input placeholder="请输入分类名" v-model="queryParams.name"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="5">
        ...
        <el-col :span="4">
          <el-button type="primary" :icon="Search" @click="queryCategoryListByParams">搜索</el-button>
      ...
      <el-row style="margin-top: 20px;">
        <el-table :data="categoryList" max-height="400" style="width: 100%"  v-loading="loading">
          ...
          <el-table-column align="center" prop="articleCount" label="文章篇数">
            <template #default="scope">
                <el-badge :value="scope.row.articleCount" class="item" type="primary"/>
              </template>
          </el-table-column>
...
import {getAllCategoryDetailList,insertCategory,updateCategory,deleteCategory} from "@/api/category"
