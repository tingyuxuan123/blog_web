    ...
    <div class="span">
        ...
        <el-row :gutter="20">
            ...
            <el-form-item label="分类名">
                <el-input placeholder="请输入标签名" v-model="form.name"></el-input>
            </el-form-item>
            </el-col>
            <!-- <el-col :span="5">
        ...
        <el-row style="margin-top: 20px;">
            <el-table :data="spanList" height="250" style="width: 100%">
            <el-table-column type="selection" width="100"/>
            <el-table-column prop="id"  label="id" width="100"/>
            <el-table-column prop="date" label="标签名"  />
        ...
        <el-dialog v-model="addViewVisible" title="添加标签" style="width: 600px;">
        <el-form :model="form">
...
<script lang='ts' setup name="span">
...
let spanList=reactive<Array<{id:number,name:string,remark:string,status:'0' |'1'}>>([]);
