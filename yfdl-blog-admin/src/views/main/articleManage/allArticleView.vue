  ...
  <div class="allArticle">
    <el-form :model="form">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="关键词">
            <el-input placeholder="请输入分类名" v-model="form.title"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="4">
        ...
        <el-col :span="4">
          <el-button type="primary" :icon="Search" @click="queryAll">查询</el-button>
      ...
      <el-row :gutter="0">
        ...
        <el-button :icon="Plus" type="primary" plain @click="toWrite()">添加</el-button>
        ...
        <el-table :data="articleList" height="100%" style="width: 100%" >
          ...
          <el-table-column  label="状态" width="100">
            <template #default="scope">
              <span v-if="scope.row.status==1"><i class="point_cg"></i>草稿箱</span>
          ...
          <el-table-column prop="viewCount" label="访问"  width="100px" >
            <template #default="scope">
              <el-badge :value="scope.row.viewCount" class="item" type="primary"/>
            </template>
          </el-table-column>
