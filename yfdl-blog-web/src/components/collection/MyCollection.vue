  ...
  <div class="collection">
    <div class="wrapper">
      <div class="collectionForm">
        ...
        <div class="content">
          <el-empty v-if="collectionList.length<=0" :image-size="200" description="还没创建过收藏夹,先去创建一个吧！"/>
          <div class="collectionItem" v-else v-for="item in collectionList">
              ...
              <div class="item-right">
                  <input type="checkbox" :value="item.id" @click="selectCollection(item.id)">
              </div>
          </div>
        ...
        <div class="footer">
          ...
          <span @click="newCollection"><el-icon><Plus /></el-icon> 新建收藏夹</span>
